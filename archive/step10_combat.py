...
def handle(client, addr):
    ...
    print("[ACTION] Look 3 tiles to the right. Attack the living fierce wild boar. Step 10 should animate the player swing and the boar damage reaction.")
...
def main():
    print(f"[LOCAL SERVER STEP 10] listening on {HOST}:{PORT}")
    print(f"[LOCAL SERVER STEP 10] embedded world-init packets={len(WORLD_BURST)}")
    print("[LOCAL SERVER STEP 10] Real game server is NOT contacted.")
    print()
